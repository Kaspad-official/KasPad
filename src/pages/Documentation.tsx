        ...
        <div className="col-span-3">
          <div className="card">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-semibold mb-2 text-primary">KaspaPad Solution</h3>
                <p className="text-text-secondary">Leveraging Kaspa network's high performance and low fees, KaspaPad provides a scalable, decentralized fundraising platform that attracts developers and investors, driving continuous growth of the Kaspa ecosystem.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card">
            ...
            <div className="mt-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-text-secondary">20M KPAD (20%) allocated for liquidity. One-third of funds raised from public sale will be paired with 20M KPAD at 1 KPAD = 0.0005 KAS.</p>
                </div>
                <div>
